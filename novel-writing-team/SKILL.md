...
3. word count ±20% จากเป้าหมาย
4. คุณภาพไม่ drift ระหว่าง batch
5. ถ้าไม่ผ่าน → ย้อนกลับแก้ สูงสุด 2 รอบ
...
10. Draft quality gate (prose authenticity + word count + dialogue density)
11. Rewrite pass + rewrite log
12. Final continuity + word-count audit
13. Editorial polish pass + polish log
